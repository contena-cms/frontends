 ...
 * Instead override it in your contena.d.ts file.
 *
 * Contena API version: 6.7.10.1
 *
 */
type GenericRecord =
  | never
...
export type Schemas = {
  ...
  CmsBlock: {
    ...
    customFields?: CustomFields | null;
    extensions?: {
      ctCmsExtensionsBlockRule?: {
        data?: {
          /** @example c426e9e5d9031b933f89682d49bb02b1 */
          id?: string;
          /** @example ct_cms_extensions_block_rule */
          type?: string;
        };
        links?: {
          /**
           * Format: uri-reference
           * @example /cms-block/9c16ffe823ddccc710bfb336c2ef30b6/ctCmsExtensionsBlockRule
           */
          related?: string;
        };
      };
      ctCmsExtensionsQuickview?: {
        data?: {
          /** @example fae098a43df8714eda5249176ffcf26c */
          id?: string;
          /** @example ct_cms_extensions_quickview */
          type?: string;
        };
        links?: {
          /**
           * Format: uri-reference
           * @example /cms-block/9c16ffe823ddccc710bfb336c2ef30b6/ctCmsExtensionsQuickview
           */
          related?: string;
        };
      };
  ...
  CmsPage: {
    ...
    entity?: string;
    extensions?: {
      ctCmsExtensionsScrollNavigationPageSettings?: {
        data?: {
          /** @example 8b835206d09f3dec1b733f6a78c7ba33 */
          id?: string;
          /** @example ct_cms_extensions_scroll_navigation_page_settings */
          type?: string;
        };
        links?: {
          /**
           * Format: uri-reference
           * @example /cms-page/64bf107168bcd03626208c1764ce6890/ctCmsExtensionsScrollNavigationPageSettings
           */
          related?: string;
        };
      };
  ...
  CmsSection: {
    ...
    customFields?: CustomFields | null;
    extensions?: {
      ctCmsExtensionsScrollNavigation?: {
        data?: {
          /** @example 425b8d6ec722d74191c6d39370af19dc */
          id?: string;
          /** @example ct_cms_extensions_scroll_navigation */
          type?: string;
        };
        links?: {
          /**
           * Format: uri-reference
           * @example /cms-section/d08def49fa8924d6f4a32bdb448d5fba/ctCmsExtensionsScrollNavigation
           */
          related?: string;
        };
      };
    ...
    extensions?: {
      ctCmsExtensionsForm?: {
        data?: {
          ...
          id?: string;
          /** @example ct_cms_extensions_form */
          type?: string;
        };
        links?: {
          /**
           * Format: uri-reference
           * @example /cms-slot/ac5ca6960137c6b8a97c90c11b71d4bb/ctCmsExtensionsForm
           */
          related?: string;
        };
      };
  ...
  Criteria: {
    ...
    fields?: string[];
    /** List of filters to restrict the search result. For more information, see [Search Queries > Filter](https://contena.stoplight.io/docs/store-api/docs/concepts/search-queries.md#filter) */
    filter?: (
      | components["schemas"]["SimpleFilter"]
      | components["schemas"]["EqualsFilter"]
      | components["schemas"]["MultiNotFilter"]
    ...
    /** Search result page */
    page?: number;
    /** Filters that applied without affecting aggregations. For more information, see [Search Queries > Post Filter](https://contena.stoplight.io/docs/store-api/docs/concepts/search-queries.md#post-filter) */
    "post-filter"?: (
      | components["schemas"]["SimpleFilter"]
      | components["schemas"]["EqualsFilter"]
      | components["schemas"]["MultiNotFilter"]
  ...
  JoinAppointmentResponse: {
    ...
    /** The new context token will be used in the header (ct-context-token) for calling the other routes */
    ...
    extensions?: {
      ctCmsExtensionsForms?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /mail-template/901aa1bf1715ad482f037eaa8b9cdc3a/ctCmsExtensionsForms
           */
          related?: string;
        };
      };
  ...
  Product: {
    ...
    extensions?: {
      ...
      ctCustomizedProductsTemplate?: {
        data?: {
          /** @example 6e9fad30dd3cb84748a01bb8152f4769 */
          id?: string;
          /** @example ct_customized_products_template */
          type?: string;
        };
        links?: {
          /**
           * Format: uri-reference
           * @example /product/deb10517653c255364175796ace3553f/ctCustomizedProductsTemplate
           */
          related?: string;
        };
      };
    ...
    extensions?: {
      ctCmsExtensionsBlockRules?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /rule/ab7a485ebe75b6dd7243ad719f23c7de/ctCmsExtensionsBlockRules
           */
          related?: string;
        };
      };
  ...
  SalesChannelContext: {
    ...
    itemRounding: {
      /** @enum {string} */
      apiAlias: "contena_core_framework_data_abstraction_layer_pricing_cash_rounding_config";
      /** Format: int32 */
      decimals: number;
      /** Format: float */
      interval: number;
  ...
  CtCmsExtensionsForm: {
    ...
    /** Format: date-time */
    readonly createdAt?: string;
    groups?: components["schemas"]["CtCmsExtensionsFormGroup"][];
    id: string;
    isTemplate?: boolean;
  ...
  CtCmsExtensionsFormGroup: {
    /** Format: date-time */
    readonly createdAt?: string;
    fields?: components["schemas"]["CtCmsExtensionsFormGroupField"][];
    form?: components["schemas"]["CtCmsExtensionsForm"];
    formId?: string;
    id: string;
    /** Format: int64 */
    position: number;
  ...
  CtCmsExtensionsFormGroupField: {
    config?: GenericRecord;
    /** Format: date-time */
    readonly createdAt?: string;
    errorMessage?: string;
    group?: components["schemas"]["CtCmsExtensionsFormGroup"];
    groupId?: string;
    id: string;
    label: string;
    placeholder?: string;
  ...
  CtCustomizedProductsTemplate: {
    active?: boolean;
    configurations?: components["schemas"]["CtCustomizedProductsTemplateConfiguration"][];
    ...
    description?: string;
    displayName: string;
    exclusions?: components["schemas"]["CtCustomizedProductsTemplateExclusion"][];
    id: string;
    internalName: string;
    media?: components["schemas"]["Media"];
    mediaId?: string;
    options?: components["schemas"]["CtCustomizedProductsTemplateOption"][];
  ...
  CtCustomizedProductsTemplateConfiguration: {
    configuration: GenericRecord;
    /** Format: date-time */
    readonly createdAt?: string;
    hash: string;
    id: string;
    template?: components["schemas"]["CtCustomizedProductsTemplate"];
    templateConfigurationShares?: components["schemas"]["CtCustomizedProductsTemplateConfigurationShare"][];
    templateId: string;
  ...
  CtCustomizedProductsTemplateConfigurationJsonApi: components["schemas"]["resource"] & {
    configuration: GenericRecord;
    /** Format: date-time */
    readonly createdAt?: string;
    hash: string;
    ...
    relationships?: {
      template?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-configuration/ab78fa5f6df63876a7c6575bdf517fe2/template
           */
          related?: string;
        };
      };
      templateConfigurationShares?: {
        data?: {
          ...
          id?: string;
          /** @example ct_customized_products_template_configuration_share */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-configuration/ab78fa5f6df63876a7c6575bdf517fe2/templateConfigurationShares
           */
          related?: string;
        };
      };
  ...
  CtCustomizedProductsTemplateConfigurationShare: {
    /** Format: date-time */
    readonly createdAt?: string;
    id?: string;
    /** Format: date-time */
  ...
  CtCustomizedProductsTemplateExclusion: {
    conditions?: components["schemas"]["CtCustomizedProductsTemplateExclusionCondition"][];
    /** Format: date-time */
    readonly createdAt?: string;
    id: string;
    name: string;
  ...
  CtCustomizedProductsTemplateExclusionCondition: {
    /** Format: date-time */
    readonly createdAt?: string;
    id: string;
    templateExclusion?: components["schemas"]["CtCustomizedProductsTemplateExclusion"];
    templateExclusionId: string;
    templateExclusionOperator?: components["schemas"]["CtCustomizedProductsTemplateExclusionOperator"];
    templateExclusionOperatorId: string;
    templateExclusionVersionId?: string;
    templateOption?: components["schemas"]["CtCustomizedProductsTemplateOption"];
    templateOptionId: string;
    templateOptionValues?: components["schemas"]["CtCustomizedProductsTemplateOptionValue"][];
    templateOptionVersionId?: string;
    /** Format: date-time */
    readonly updatedAt?: string;
    versionId?: string;
  };
  CtCustomizedProductsTemplateExclusionOperator: {
    /** Format: date-time */
    readonly createdAt?: string;
    id: string;
    label: string;
    operator: string;
    templateExclusionConditions?: components["schemas"]["CtCustomizedProductsTemplateExclusionCondition"][];
  ...
  CtCustomizedProductsTemplateJsonApi: components["schemas"]["resource"] & {
    active?: boolean;
    confirmInput?: boolean;
    /** Format: date-time */
    readonly createdAt?: string;
    ...
    relationships?: {
      configurations?: {
        data?: {
          ...
          id?: string;
          /** @example ct_customized_products_template_configuration */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template/4751e4cb483e992aa073494b9cfa9be6/configurations
           */
          related?: string;
        };
      };
      exclusions?: {
        data?: {
          ...
          id?: string;
          /** @example ct_customized_products_template_exclusion */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template/4751e4cb483e992aa073494b9cfa9be6/exclusions
           */
          related?: string;
        };
      };
      media?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template/4751e4cb483e992aa073494b9cfa9be6/media
           */
          related?: string;
        };
      };
      options?: {
        data?: {
          /** @example 93da65a9fd0004d9477aeac024e08e15 */
          id?: string;
          /** @example ct_customized_products_template_option */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template/4751e4cb483e992aa073494b9cfa9be6/options
           */
          related?: string;
        };
      };
      products?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template/4751e4cb483e992aa073494b9cfa9be6/products
           */
          related?: string;
        };
      };
  ...
  CtCustomizedProductsTemplateOption: {
    ...
    position?: number;
    price?: components["schemas"]["Price"][];
    prices?: components["schemas"]["CtCustomizedProductsTemplateOptionPrice"][];
    ...
    /** Format: date-time */
    readonly updatedAt?: string;
    values?: components["schemas"]["CtCustomizedProductsTemplateOptionValue"][];
  };
  CtCustomizedProductsTemplateOptionJsonApi: components["schemas"]["resource"] & {
    advancedSurcharge?: boolean;
    calculatedPrice?: GenericRecord;
    /** Format: date-time */
    readonly createdAt?: string;
    ...
    relationships?: {
      prices?: {
        data?: {
          /** @example afae32efe0f84fece3f96b377b768b33 */
          id?: string;
          /** @example ct_customized_products_template_option_price */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option/6342f0c20b443cb5408ec0fc12430bcb/prices
           */
          related?: string;
        };
      };
      tax?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option/6342f0c20b443cb5408ec0fc12430bcb/tax
           */
          related?: string;
        };
      };
      template?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option/6342f0c20b443cb5408ec0fc12430bcb/template
           */
          related?: string;
        };
      };
      templateExclusionConditions?: {
        data?: {
          ...
          id?: string;
          /** @example ct_customized_products_template_exclusion_condition */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option/6342f0c20b443cb5408ec0fc12430bcb/templateExclusionConditions
           */
          related?: string;
        };
      };
      values?: {
        data?: {
          ...
          id?: string;
          /** @example ct_customized_products_template_option_value */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option/6342f0c20b443cb5408ec0fc12430bcb/values
           */
          related?: string;
        };
      };
  ...
  CtCustomizedProductsTemplateOptionPrice: {
    /** Format: date-time */
    readonly createdAt?: string;
    id: string;
    /** Format: float */
  ...
  CtCustomizedProductsTemplateOptionValue: {
    advancedSurcharge?: boolean;
    calculatedPrice?: GenericRecord;
    /** Format: date-time */
    readonly createdAt?: string;
    ...
    position: number;
    price?: components["schemas"]["Price"][];
    prices?: components["schemas"]["CtCustomizedProductsTemplateOptionValuePrice"][];
    relativeSurcharge?: boolean;
    tax?: components["schemas"]["Tax"];
    taxId?: string;
    templateExclusionConditions?: components["schemas"]["CtCustomizedProductsTemplateExclusionCondition"][];
  ...
  CtCustomizedProductsTemplateOptionValueJsonApi: components["schemas"]["resource"] & {
    advancedSurcharge?: boolean;
    calculatedPrice?: GenericRecord;
    /** Format: date-time */
    readonly createdAt?: string;
    ...
    relationships?: {
      prices?: {
        data?: {
          /** @example afae32efe0f84fece3f96b377b768b33 */
          id?: string;
          /** @example ct_customized_products_template_option_value_price */
          type?: string;
        }[];
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option-value/b57f26a8362182be3e67a815927b7f37/prices
           */
          related?: string;
        };
      };
      tax?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option-value/b57f26a8362182be3e67a815927b7f37/tax
           */
          related?: string;
        };
      };
      templateExclusionConditions?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option-value/b57f26a8362182be3e67a815927b7f37/templateExclusionConditions
           */
          related?: string;
        };
      };
      templateOption?: {
        ...
        links?: {
          /**
           * Format: uri-reference
           * @example /ct-customized-products-template-option-value/b57f26a8362182be3e67a815927b7f37/templateOption
           */
          related?: string;
        };
      };
  ...
  CtCustomizedProductsTemplateOptionValuePrice: {
    /** Format: date-time */
    readonly createdAt?: string;
    id: string;
    /** Format: float */
    ...
    rule?: components["schemas"]["Rule"];
    ruleId?: string;
    templateOptionValue?: components["schemas"]["CtCustomizedProductsTemplateOptionValue"];
  ...
  CtDynamicAccessLandingPageRule: {
    id?: string;
  ...
  CtPaypalVaultTokenMapping: {
    ...
    paymentMethod?: components["schemas"]["PaymentMethod"];
    paymentMethodId: string;
    token?: components["schemas"]["CtPaypalVaultToken"];
    tokenId: string;
    /** Format: date-time */
    readonly updatedAt?: string;
  };
  CtSocialShoppingCustomer: {
    /** Format: date-time */
    readonly createdAt?: string;
    id: string;
    /** Format: date-time */
...
export type operations = {
  ...
  "readCategoryListGet get /category": {
    ...
    accept?: "application/json";
    headers?: {
      /** Instructs Contena to return the response in the given language. */
      "ct-language-id"?: string;
    };
    query?: {
  ...
  "readCategoryGet get /category/{navigationId}": {
    ...
    accept?: "application/json";
    headers?: {
      /** Instructs Contena to try and resolve SEO URLs for the given navigation item */
      "ct-include-seo-urls"?: boolean;
      /** Instructs Contena to return the response in the given language. */
      "ct-language-id"?: string;
    };
    query?: {
  ...
  "readProductDetailGet get /product/{productId}": {
    ...
    query?: {
      ...
      /** The query string to search for */
      query?: components["parameters"]["criteriaQuery"];
      /** Instructs Contena to skip loading the CMS page data */
      skipCmsPage?: boolean;
      /** Instructs Contena to skip loading the configurator data */
