# contena/frontends - api-client

[![](https://img.shields.io/npm/v/@contena/api-client?color=blue&logo=data:image/svg+xml;base64,)](https://npmjs.com/package/@contena/api-client)
[![](https://img.shields.io/github/package-json/v/contena/frontends?color=blue&filename=packages%2Fapi-client%2Fpackage.json&label=frontends/api-client&logo=github)](https://github.com/contena/frontends/tree/main/packages/api-client)
[![](https://img.shields.io/github/issues/contena/frontends/api-client?label=package%20issues&logo=github)](https://github.com/contena/frontends/issues?q=is%3Aopen+is%3Aissue+label%3Aapi-client)
[![](https://img.shields.io/github/license/contena/frontends?color=blue)](#)

Dynamic and fully typed API Client for Contena 6. Usable in any JavaScript and TypeScript project.
You can use types generated from your custom API instance to have autocompletion and type safety.

To generate your own types use [@contena/api-gen](https://www.npmjs.com/package/@contena/api-gen) CLI.

## Setup

Install npm package:

<!-- automd:pm-install name="@contena/api-client" -->

```sh
# ✨ Auto-detect
npx nypm install @contena/api-client

# npm
npm install @contena/api-client

# yarn
yarn add @contena/api-client

# pnpm
pnpm add @contena/api-client

# bun
bun install @contena/api-client

# deno
deno install npm:@contena/api-client
```
...
```typescript
import { createAPIClient } from "@contena/api-client";

// You can pick types of your current API version, the default one:
import type { operations } from "@contena/api-client/store-api-types";
// or - RECOMMENDED - your types generated by [@contena/api-gen](https://www.npmjs.com/package/@contena/api-gen) CLI:
...
export const apiClient = createAPIClient<operations>({
  baseURL: "https://demo-frontends.contena.store/store-api",
  accessToken: "SWSCBHFSNTVMAWNZDNFKSHLAYW",
  contextToken: Cookies.get("ct-context-token"),
});

apiClient.hook("onContextChanged", (newContextToken) => {
  Cookies.set("ct-context-token", newContextToken, {
    expires: 365, // days
    path: "/",
    sameSite: "lax",
    secure: contenaEndpoint.startsWith("https://"),
  });
});
```
...
```typescript
import { createAdminAPIClient } from "@contena/api-client";
```
...
import type {
  operations,
} from "@contena/api-client/admin-api-types"; // we take default admin api types from different directory than store-api - use your own types by generating schema with @contena/api-gen CLI
import type { operations } from "./api-types/adminApiTypes"; // or use your own types generated by @contena/api-gen CLI
...
import { createAdminAPIClient } from "@contena/api-client"; // we use different function to create admin api client

import { createAdminAPIClient } from "@contena/api-client";
import type { operations, Schemas } from "@contena/api-client/admin-api-types"; // we take default admin api types from different directory than store-api
import Cookies from "js-cookie";

export const adminApiClient = createAdminAPIClient<operations>({
  baseURL: "https://demo-frontends.contena.store/api",
  sessionData: JSON.parse(Cookies.get("ct-admin-session-data") || "{}"),
});

adminApiClient.hook("onAuthChange", (sessionData) => {
  Cookies.set("ct-admin-session-data", JSON.stringify(sessionData), {
    expires: 1, // days
    path: "/",
    sameSite: "lax",
    secure: contenaEndpoint.startsWith("https://"),
...
The client is fully typed via a generic `operations` parameter. You can use the bundled default types or generate and override types from your own Contena instance.

### Generating types from your instance

Use [@contena/api-gen](https://www.npmjs.com/package/@contena/api-gen) to generate TypeScript types directly from your Contena instance's OpenAPI schema.

```bash
# 1. Load the schema from your running Contena instance
...
This creates `api-types/storeApiTypes.ts` (or `adminApiTypes.ts` for Admin API). Point `contena.d.ts` to your generated types instead of the bundled defaults:

```typescript
// contena.d.ts
declare module "#contena" {
  import type { createAPIClient } from "@contena/api-client";
...
All code importing from `#contena` will now use your instance's types automatically.
...
Then point `contena.d.ts` to the overrides file instead of the generated one:
...
Your `apiClient.ts` already imports from `#contena`, so no change is needed there — the overridden types flow through automatically.
...
See the [@contena/api-gen documentation](https://www.npmjs.com/package/@contena/api-gen) for the full patching reference and available configuration options.

## Basic usage

Take a look at [example project using API Client](https://stackblitz.com/github/contena/frontends/tree/main/examples/new-api-client).
...
console.log(config.baseURL); // "https://demo-frontends.contena.store/store-api"
...
Related issue: https://github.com/contena/contena/issues/12388
...
Full changelog for stable version is available [here](https://github.com/contena/frontends/blob/main/packages/api-client/CHANGELOG.md)
