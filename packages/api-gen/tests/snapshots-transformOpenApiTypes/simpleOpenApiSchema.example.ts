...
export type components = {
  ...
  responses: {
    ...
    /** Returns the context token. Use that as your `ct-context-token` header for subsequent requests. Redirect if getRedirectUrl is set. */
    ContextTokenResponse: {
      headers: {
        /** Contains ct-context-token value */
        "ct-context-token"?: string;
      };
      content: {
        "application/json": {
          /**
